...
//		fail("Not yet implemented");
		...
		SingleNode sum = test.sumOfIntsReverseOrder(n1, n4);
	...
	@Test
	public void testSumOfIntsForward(){
		SingleNode n1 = new SingleNode(6);
		SingleNode n2 = new SingleNode(1);
		SingleNode n3 = new SingleNode(7);
		n1.next = n2;
		n2.next = n3;
		n3.next = null;
		
		SingleNode n4 = new SingleNode(2);
		SingleNode n5 = new SingleNode(9);
		SingleNode n6 = new SingleNode(5);
		n4.next = n5;
		n5.next = n6;
		n6.next = null;
		SumOfInts25 test = new SumOfInts25();
		SingleNode sum = test.sumOfIntsForward(n1, n4);
		System.out.println(sum.toString());
	}
